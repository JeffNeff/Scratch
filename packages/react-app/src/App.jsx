...
// 🛰 providers
const providers = [
  "https://polygon-mainnet.infura.io/v3/61979797a8bb4bfe9dddd4ff9675db7e",
...
function App(props) {
  ...
  const networkOptions = [initialNetwork.name, "mainnet", "polygon", "mumbai"];
  ...
  const purpose = useContractReader(readContracts, "Lottery", "purpose");
